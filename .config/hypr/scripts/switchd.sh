...
# Configuration files
QT5CT_CONFIG="/home/ayu/.config/qt5ct/qt5ct.conf"
QT6CT_CONFIG="/home/ayu/.config/qt6ct/qt6ct.conf"
GTK4_TARGET="/home/ayu/.config/gtk-4.0"
...
change_gtk4_theme() {
    ...
    case "$theme" in
        "Nord")
            gtk4_source="/home/ayu/.themes/Lavanda-Sea-Dark/gtk-4.0"
            ;;
        "Dracula")
...
case "$1" in
    -d|--dracula)
        change_all_themes "Tela-circle-dracula" "Tela-circle-dracula" "Dracula" "Dracula"
        ;;
    -g|--gruv)
        change_all_themes "Tela-circle-black" "Tela-circle-black" "Gruvbox" "Gruv"
        ;;
    -n|--nord)
        change_all_themes "Tela-circle-nord" "Tela-circle-nord" "Nord" "Nord"
        ;;
    *)
