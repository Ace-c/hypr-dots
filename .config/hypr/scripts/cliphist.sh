...
# read hypr theme border ( Uncomment it if you want to use hypr border)
...
case $1 in
    ...
    *)  echo -e "cliphist.sh [action]"
        ...
        echo "f : output number of history items in JSON format for Waybar"
        exit 1
        ;;
esac
