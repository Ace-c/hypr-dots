...
const float brightnessIncrease = 0.02; // Adjust this value to change brightness (0.0 to 1.0)
const float temperature = 6100.0;
...
void main() {
    ...
    // Adjust brightness
    color = adjustBrightness(color, brightnessIncrease);
